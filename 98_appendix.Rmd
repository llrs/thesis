...
Designed to be used with RGCCA I wrote [inteRmodel](https:github.com/llrs/inteRmodel) to ease the bootstrapping and model selection. 
...
A package to analyze sets and fuzzy sets [BaseSet](https://github.com/llrs/BaseSet).
This package was meant to be used with the probabilities that arise from bootstrapping the models.
However due to the long times of calculation that it would require it was not used. (A previous iteration of the package called [GSEAdv](https://github.com/llrs/GSEAdv) was developed too.)
...
[Multi-omic modelling of inflammatory bowel disease with regularized canonical correlation analysis](https://doi.org/10.1101/2020.04.16.20031492):
 ...
 - [integration](https://github.com/llrs/integration-helper): Package with functions that I wrote several times on the TRIM ended up here.
 
Paper 2:

 - [Barcelona](https://github.com/llrs/Barcelona): Mangle with the sample, dataset ...
 - [inteRmodel](https://github.com/llrs/inteRmodel): To repeat the same procedure as in the first analysis.
