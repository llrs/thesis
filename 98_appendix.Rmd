...
-   [uncoupling](https://github.com/llrs/Uncoupling): Work with the UC/CD dataset used in this article.
...
-   [experDesign](https://github.com/llrs/experDesign): Help design experiments in batches, [available on CRAN too](https://cran.r-project.org/package=experDesign).
