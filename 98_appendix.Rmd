...
We used a pouchitis cohort published in this [article](https://dx.doi.org/10.1186/s13059-015-0637-x)[@morgan2015] that was used to compare how does our own method does in other's dataset: [pouchitis](https://github.com/llrs/pouchitis).

Some functions used to explore the TRIM dataset ended up in the [integration](https://github.com/llrs/integration-helper) package.This include functions for correlation and network analysis.

A package to analyze sets and fuzzy sets [BaseSet](https://github.com/rOpenSci/BaseSet).
...
(A previous iteration of the [package](https://github.com/llrs/GSEAdv "GSEAdv package") existed previously)
