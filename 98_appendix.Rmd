...
-   [sgcca_hyperparameters](https://github.com/llrs/sgcca_hyperparameters "RGCCA exploration code on github"): Explore the effects of the hyperparameters on RGCCA on the provided dataset.
...
-   [pouchitis](https://github.com/llrs/pouchitis "Pouchitis code on github"): Work with the pouchitis cohort used in this article.
-   [uncoupling](https://github.com/llrs/Uncoupling "Uncoupling code on github"): Work with the UC/CD dataset used in this article.
...
-   [BaseSet](https://cran.r-project.org/package=BaseSet "BaseSet landing page on CRAN"): Fuzzy logic implementation, available on [rOpenSci too](https://github.com/ropensci/BaseSet "BaseSet git repository")

experDesign:

-   [experDesign](https://github.com/llrs/experDesign "Git repository"): Help design experiments in batches, [available on CRAN too](https://cran.r-project.org/package=experDesign "experDesign landing page on CRAN").
