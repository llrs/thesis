...
[Check proteobacteria role on dysbiosis [@mukhopadhya2012] ]
...
Several explanations has been proposed of the origin of the disease [@zhang2014; @hugot2004] .
...
There is a classification between very early, early or adult on-set disease [@satsangi2006b].
On very early on-set the genetic component is high (See [Clinical care] section).
GWAS studies has linked the IBD disease to *NOD2* gene, but so far there isn't any known mechanism how this gene could start the disease [@horowitz2021].
...
The proposed mechanism has not been confirmed yet [@horowitz2021].
