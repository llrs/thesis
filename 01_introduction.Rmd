...
-   A predictive model
    ...
    This kind of methods are used improve treatments, diagnosis and prognosis prediction \[@wheeler2014\].

-   Impute values

    Some methods aim to accurately guess which values have one block given some other information.
    Missing values can happen for a variety of reasons from practical ones, like a sample not being available, to technical ones, such as laboratory method failing [@yin2019a].
