...
Partly due to the multiple variables already identified that have been linked to IBD; for instance, age, diet, usage of antibiotic, tobacco, and socioeconomic status [@humanmicrobiomeprojectconsortium2012].
...
```{r barrier, fig.cap="The intestinal epithelial barrier.", fig.alt="The intestinal epithelial barrier. Graphic showing the small intestine with different cells types and the bacteria close to the intestinal epithelial."}
...
```{r classification, fig.scap="Unsupervised data integration methodology.", fig.cap="Unsupervised data integration methodology. Figure 1 from Huang 2017."}
