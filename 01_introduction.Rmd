...
$\beta$-diversity compares the diversity between samples of the same study.
Typically a horse-
...
Intestinal epithelial cells play a key role in controling the integrity of the intestinal microorganisms [@hisamatsu2013] not only physically but also secreting antimicrobial peptides and defensins, both of which are altered in IBD patients [@michielan2015].
The intestinal epithelium also plays a key role on the intake and difusion of metabolites from the intestinal lumen to the lamina propia.
Damaging or increasing the permeability of the intestinal epithelium results on a more intense response from the immune system.
