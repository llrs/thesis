...
For active module identification the
...
Understanding how to interpret the results of the methods is highly tight to understanding the method and its output.
...
The methods are so complex that they need some articles explaining it [@sherry2005].
The interpretation also help to discuss the results and relate it to other previously know information.
...
Around 3.5 million individuals have IBD in Europe and North America combined [@jairath2020]. The disease has been used as a condition that prevents people to [apply to certain positions](https://civio.es/el-boe-nuestro-de-cada-dia/2019/02/13/las-enfermedades-que-vetan-el-acceso-a-ciertos-empleos-publicos/ "Link to a Civio.es about disease disqualifying for some public positions").
