...
```{r composition, fig.cap="The microbial composition in a healthy and IBD gut.", fig.alt="Microbial composition and epithelial barrier status in healthy versus IBD gut."}
...
```{r barrier, fig.cap="The intestinal epithelial barrier.", fig.alt="The intestinal epithelial barrier"}
