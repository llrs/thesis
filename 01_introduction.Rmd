...
*Faecalibacterium prausnitzii* is the microorganism that has been more associated with IBD [citation needed].
But several other microorganisms have been also linked to it.
...
The mucus is organized in two layers: the inner layer, a firm mucus layer; and the outer, loose mucus layer [@okumura2017]. Later the intestinal epithelium is a single layer of cells organized into crypts and villi (and circular folds on the large intestine) that carries out a diverse array of functions besides digestion performed by specialized cell lineages.
