...
<!-- # TODO add references on ref:needed -->
...
Nevertheless, many patients are refractory or intolerant to those therapies and need to undergo surgery or other strategies like dietetic and psychological support [@raine2021a] .
...
-   Classification of the patients or samples
    ...
    This might be to accurately describe whether a patient has one or other related disease of a possible subset of diseases given their condition [@rohart2016].
...
-   An overview of the role of each individual block in a biological system
    ...
    An example of this is the search of markers on blood to identify links between different cell populations [@tang2017a; @ibrahim2017].
...
-   Finding a molecular signature.
    ...
    There are several methods that are used to do this [@cavill2016a].\
    An example of this is when performing eQTL, where a locus is related to the expression change of genes, so finding the right positions that induce a specific expression level is a very common task [@repnik2016; @hu2021; @jung2020; @dai2019].
