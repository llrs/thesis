...
: (#tab:Puget) Table about Puget's dataset characteristics.
...
: (#tab:HSCT) Table of HSCT dataset characteristics.
...
: (#tab:Hasler) Table of Häsler's dataset characteristics.
...
: (#tab:Morgan) Table of Morgan's dataset characteristics.
...
: (#tab:BARCELONA) Table of samples included from the BARCELONA dataset characteristics.
...
: (#tab:howell) Table of samples included from Howell's dataset characteristics.

### Hernández' dataset {#methods-hernandez}

This dataset was obtained after a collaboration "Integrative analysis of colonic biopsies from IBD patients identifies an interaction between microbial bile-acid inducible gene abundance and human Angiopoietin-like 4 gene expression" [@hernández-rocha2021].
...
290 samples were collected together with information about the disease, age at diagnosis, age at the moment of the sampling, sex, segment and smoking status.
...
| Segment (ileum/colon)                   | 97/193     |

: (#tab:hernandez) Table of samples included from Hernández's dataset characteristics.
...
Regularized generalized canonical correlation analysis is implemented on the homonymous package [RGCCA](https://cran.r-project.org/package=RGCCA) [@tenenhaus2017] which was used on this thesis.
The method and implementation will be explained in detail on the next section.

![ (#fig:workflow-process) Workflow of the analysis process](images/workflow%20integration.png)
