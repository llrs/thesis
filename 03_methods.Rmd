...
These biopsies included samples from the terminal ileum and sigma from CD, \acr{UC}, infectious disease-controls and healthy non-IBD.
...
In this study patients having undergone proctocolectomy with ileal pouch-anal anastomosis for treatment of \acr{UC} or familial adenomatous polyposis at least 1 year prior to enrollment were recruited at Mount Sinai Hospital (Toronto, Canada) excluding individuals with a diagnosis of CD.
...
There are 10 non-IBD samples, 11 with CD and 11 with \acr{UC}.
...
|:------------------------------------------------|:---------:|
| Disease (non-IBD/CD/\acr{UC})                         | 11/10/11  |
...
It has been widely used since its original publication, also in IBD [@protiva2016].
