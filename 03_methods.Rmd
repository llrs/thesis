...
```{r workflow-process, fig.cap="Workflow of the analysis process."}
...
```{r multiomic-datasets, fig.scap="Multiomic relationships.", fig.cap="Multiomic relationships on different datasets. Integration methods focus on relationships within datasets. Common relationships between datasets are used as confirmation/validation."}
