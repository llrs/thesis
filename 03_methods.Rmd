...
Table: (#tab:Puget) Puget's dataset characteristics.
...
Table: (#tab:HSCT) HSCT dataset characteristics.
...
Table: (#tab:Hasler) Table of Häsler's dataset characteristics.
...
Table: (#tab:Morgan) Table of Morgan's dataset characteristics.
...
Table: (#tab:howell) Table of samples included from Howell's dataset characteristics.
...
Table: (#tab:hernandez) Table of samples included from Hernández's dataset characteristics.
...
![(#fig:workflow-process) Workflow of the analysis process](images/workflow_integration2.png)
...
Table: (#tab:RGCCA-methods) Equivalences of RGCCA for multi-block data analysis to other methods
...
<!--# TODO Fill with the fisher test-->
...
$$
D_{\text{inverse Simpson}} = \dfrac{1}{\sum_{1=1}^Sp_i^2}
$$
