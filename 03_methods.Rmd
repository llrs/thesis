...
Table: (#tab:Puget) Characteristics of samples from Puget's dataset.
...
Table: (#tab:HSCT) Characteristics of samples from HSCT dataset.
...
Table: (#tab:Hasler) Characteristics of samples from Häsler's dataset.
...
Table: (#tab:Morgan) Characteristics of samples from Morgan's dataset.
...
Table: (#tab:howell) Characteristics of samples included from Howell's dataset.
