...
Variables collected include: sex, age at diagnosis, duration of the disease, age, disease status, sample location, local simple endoscopic score and \acr{CDAI}.
...
As previously described [@revilla2021], biopsies from the \acr{CD} cohort were resuspended in 180 $\mu$l TET (TrisHCl 0.02M, EDTA 0.002M, Triton 1X) buffer and 20mg/ml lysozyme (Carl Roth, Quimivita, S.A.). 
