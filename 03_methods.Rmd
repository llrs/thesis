...
The smaller the $s_j$, the larger the degree of sparsity for $a_j$, usually $s_j$ is calculated using \[@schäfer2005\] approach unless they include metadata for which 1 is then used.
