...
| \acr{CD}AI: mean (min-max)                                 | 120 (0-450  |
...
To compare between different models the area under the curve (A\acr{UC}) of the receiver operating characteristic (ROC) was calculated with the [pROC](https://cran.r-project.org/package=pROC) package [@robin2011].
