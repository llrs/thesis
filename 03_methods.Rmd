...
: (#tab:Puget) Characteristics of samples from the Puget's dataset.
...
All patients provided written consent following extensive counselling about being included on the study and using their data on publications. Variables collected include: sex, age at diagnostic, duration of the disease, age, disease status, sample location, local simple endoscopic score and \acr{CDAI}.
...
: (#tab:Hasler) Characteristics of samples from the Häsler's dataset.
...
: (#tab:Morgan) Characteristics of samples from the Morgan's dataset.
...
: (#tab:howell) Characteristics of samples from the Howell's dataset.
...
<!--# TODO mention GSVA on discussion or results...-->
