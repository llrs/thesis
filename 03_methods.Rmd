...
It uses several methods like fisher test to check the enrichment of features of a given group on the (background) list provided.
The test is usually the fisher test or the hypergeometric test or the proportion test.
