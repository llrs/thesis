...
**Introduction**: Inflammatory bowel disease is a complex intestinal disease with several environmental factors that affect each other.
...
**Methods**: We based our analysis on intestinal bacterial 16S and human transcriptome data from biopsies from multiple timepoints and intestine segments.
...
**Results**: Splitting samples variables into different blocks results on models of these relationships that show differences on the genes and microorganisms selected.
