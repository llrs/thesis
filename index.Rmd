...
**Introduction**: Inflammatory bowel disease is a complex intestinal disease with several factors that affect each other.
...
**Methods**: We based our analysis on intestinal bacterial 16S and human  transcriptome data from biopsies from multiple timepoints and locations of the intestine.
...
**Results**: Splitting samples variables into different blocks results on models of these relationships that show differences on the genes and microorganismes selected.
...
**Discussion**: Our method finds how strong are the relationships of microbiome, transcriptome and other variables.
