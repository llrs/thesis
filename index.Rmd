...
The main topic of the thesis is [data integration](https://en.wikipedia.org/wiki/Data_integration "Wikipedia page of integration") applied in the \acr{IBD} research (check [wikipedia page](https://en.wikipedia.org/wiki/Inflammatory_bowel_disease) for a brief introduction).
