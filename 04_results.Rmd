...
![(#fig:hsct-wgcna-power) Power evaluation of WGCNA of the HSCT dataset.](images/hsct-wgcna-power.png)

As can be seen on the Figure \@ref(fig:hsct-wgcna-power), the scale free topology doesn't reach the recommended threshold of 0.9 and the mean connectivity is also very low even for the first power.
...
However, it didn't find a good agreement between these two data sources and 16S data source was not longer used on the analysis.
