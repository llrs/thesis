...
k <- kable(df, caption.short = "Model 0 of HSCT dataset.",
...
k <- kable(df, caption.short = "Model 1.1 of HSCT dataset.",
...
k <- kable(df, caption.short = "Model 1.2 of HSCT dataset.", 
...
df <- data.frame(
  stringsAsFactors = FALSE,
  "Model 2" = c("Transcriptome", "Microbiome","Demographic","Location"),
  ...
  Time = c(0L, 0L, 1L, 0L),
  check.names = FALSE)
k <- kable(df, caption.short = "Model 2 of HSCT dataset.",
     ...
     Transcriptome = c(0L, 0L, 0L, 1L, 0L),
       ...
       Demographic = c(0, 0.2, 0, 0, 0.6),
          Location = c(1, 0.1, 0, 0, 0),
              Time = c(0, 0, 0.6, 0, 0),
  check.names = FALSE)
k <- kable(df, caption.short = "Model 2.2",
...
k <- kable(df, caption.short = "Model 2.3 of HSCT dataset.",
...
m2.1 <- data.frame(list(
                   ...
                   Time = c(0, 0, 0, 1, 0), 
                   check.names = FALSE)
k <- kable(m2.1, caption.short = "Model 2.1 of H\u00E4sler dataset", 
