...
If the user wants to create their own design matrices, they can use `symm` and modify the design of the model with `sbuSymm`.
...
: (#tab:Puget-model1) Relationships between the different blocks on the Puget dataset for model 1. 0 indicates no relationship and 1 indicates a strong relationship.
...
: (#tab:puget-model1-2) Relationships between the different blocks on the Puget's dataset for model 1.2. 0 indicates no relationship and 1 indicates a strong relationship.
...
: (#tab:puget-model2) Relationships between the different blocks on the Puget's dataset for model 2. 0 indicates no relationship and 1 indicates a strong relationship.
...
: (#tab:puget-model2-2) Relationships between the different blocks on the Puget's dataset for model 2.2. 0 indicates no relationship and 1 indicates a strong relationship.
...
: (#tab:puget-model-superblock) Relationships between the different blocks on the Puget's dataset for model superblock. 0 indicates no relationship and 1 indicates a strong relationship.
...
: (#tab:puget-model-superblock-2) Relationships between the different blocks on the Puget's dataset for model superblock.2. 0 indicates no relationship and 1 indicates a strong relationship.
...
```{r puget-weights, fig.scap="Effect of superblock and weights on the inner AVE on Puget's dataset.", fig.cap="Effect of superblock and weights on the inner AVE on Puget's dataset. Designs with the superblock showed higher inner AVe scores than without it. Interaction yes/no indicates RNA and CGH interaction."}
...
: (#tab:puget-models-ave) The models and their AVE values.
...
<!--# Dobule check this model with the original data -->

| Model 2.2         | Transcriptome | Microbiome | Demographic | Location | Time |
|-------------------|:-------------:|:----------:|:-----------:|:--------:|------|
| **Transcriptome** |       0       |     0      |      0      |   0.6    | 0    |
| **Microbiome**    |       0       |     0      |     0.2     |   0.1    | 0    |
| **Demographic**   |       0       |    0.2     |      0      |    0     | 1    |
| **Location**      |      0.6      |    0.1     |      0      |    0     | 0    |
| Time              |       0       |     0      |      1      |    0     | 0    |
...
<!--# TODO fix this  the model is the same as in 2.2 and it shouldn't or whould it? (wrong on the paper) -->

| Model 2.3         | Transcriptome | Microbiome | Demographic | Location |     |
|-------------------|:-------------:|:----------:|:-----------:|:--------:|-----|
| **Transcriptome** |       0       |     0      |      0      |    1     | 0   |
| **Microbiome**    |       0       |     0      |     0.1     |   0.1    | 0   |
...
The best model of the family 2 confirmed a relationship between the host transcriptome and the location-related variables, while the microbiome was associated with the demographic and location-related variables (see figure \@ref(hsct-models) and [S2](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0246367#pone.0246367.s002) data of [@revilla2021]).
...
<!--# TODO: Include plot with the result only this dataset (same for all the other datasets) -->
...
<!--# TODO include tables of the models -->
...
<!--# TODO fix this  the model is the same as in 2.2 and it shouldn't (wrong on the paper) -->
...
: (#tab:morgan-model2-3) Relationships between the different blocks on the Morgan's dataset for model 2.3. 0 indicates no relationship and 1 indicates a strong relationship.
...
<!--# TODO: Update plot (old plot without some ASV) -->
