...
```{r hsct-features, fig.scap="Upset plot of variables selected on HSCT dataset.", fig.cap="Upset plot of the variables selected on each model from 0 to 2.3 showing the intersection between them regarding genes and OTUs."}
