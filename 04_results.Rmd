...
k <- kableExtra::kable_styling(k, latex_options = c("striped", "hold_position"), full_width = FALSE, fixed_thead = TRUE)
kableExtra::column_spec(k, column = 1, border_right = TRUE, bold = TRUE)
```
