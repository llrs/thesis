...
```{r hsct-pca-16s, fig.scap="PCA of 16S data of HSCT dataset.", fig.cap = "PCA of the 16S data of the HSCT dataset. Samples colored by location of the segment. There are no clear patterns according to the location."}
...
```{r hsct-pca-rnaseq, fig.scap="PCA of RNAseq data of HSCT dataset.", fig.cap = "PCA of the RNAseq data of the HSCT dataset. Samples colored by location of the segment. The samples separate according to the location."}
...
k <- kable(df, align = rep("c", ncol(df)), 
           caption.short = "Model 0 of HSCT dataset.",
...
k <- kable(df, align = rep("c", ncol(df)), 
           caption.short = "Model 1.1 of HSCT dataset.",
...
df <- data.frame(
  ...
  check.names = FALSE)
k <- kable(df, align = rep("c", ncol(df)),
           caption.short = "Model 2 of HSCT dataset.",
...
k <- kable(df, align = rep("c", ncol(df)), 
           caption.short = "Model 2.3 of HSCT dataset.", 
...
```{r hsct-bootstrap-quality, fig.scap="Characteristics of the samples of  HSCT bootstraps.", fig.cap="Dispersion of the bootstraped samples on age and percentage of colon and controls samples."}
...
```{r hsct-mcia, fig.scap="MCIA on the HSCT dataset", fig.cap="MCIA first two synthetic variables on IBD related cohorts. In red circles the colon and in blue triangles the ileum."}
...
```{r hsct-features, fig.scap="Upset plot of variables selected on HSCT dataset.", fig.cap="Upset plot of variables selected on HSCT dataset. The variables selected on each model from 0 to 2.3 showing the intersection between them regarding genes, panel A, and OTUs, panel B."}
...
```{r hasler-pca-16s, fig.scap="PCA of 16S of Häsler's dataset.", fig.cap = "PCA of 16S of Häsler's dataset colored by the location of the samples."}
...
```{r hasler-pca-rnaseq, fig.scap="PCA of RNAseq of Häsler's dataset.", fig.cap = "PCA of RNAseq of Häsler's dataset. The samples are colored by location sigma and ileum. There are two clear groups according to the location."}
...
```{r hasler-mcia, fig.scap="MCIA result on Häsler's dataset.", fig.cap="MCIA result on Häsler's dataset. MCIA first two dimensions of the dataset colored by state, the shape is according to the location of the samples. Shows two vertical groups on the first syntethic dimension according to the location of the samples."}
...
```{r morgan-pca-16s, fig.scap="PCA of 16S of Morgan's dataset", fig.cap="PCA of 16S of Morgan's dataset. The sample are colored by location. "}
...
```{r morgan-pca-rnaseq, fig.scap="PCA of RNAseq of Morgan's dataset", fig.cap="PCA of RNAseq of Morgan's dataset. The sample are colored by location. "}
...
k <- kable(df, align = rep("c", ncol(df)),
           caption.short = "Model 0 of Morgan's dataset.",
...
k <- kable(df, align = rep("c", ncol(df)),
           caption.short = "Model 1 of Morgan's dataset.",
...
k <- kable(df, align = rep("c", ncol(df)),
           caption.short = "Model 1.2 of Morgan's dataset.",
...
k <- kable(df, align = rep("c", ncol(df)),
           caption.short = "Model 2 of Morgan's dataset.",
...
k <- kable(df, align = rep("c", ncol(df)),
           caption.short = "Model 2.2 of Morgan's dataset.",
...
k <- kable(df, align = rep("c", ncol(df)),
      caption.short = "The models on Morgan's dataset and their AVE values.",
      caption = "The models on Morgan's dataset and their AVE values. For each model the inner and outer AVE value is presented.")
format_design(k, df)
```
...
k <- kable(df, align = rep("c", ncol(df)), 
           caption.short="AUC for Morgan's dataset", 
...
```{r howell-pca-16s, fig.scap="PCA of 16S data of Howell's dataset", fig.cap = "PCA of 16S data of Howell's dataset. Samples are colored by location. There are no pattern on any of the first do dimensions."}
...
```{r howell-pca-rnaseq, fig.scap="PCA of RNASeq data of Howell's dataset", fig.cap = "PCA of RNAseq data of Howell's dataset. Samples are colored by location. There are two groups of samples according to their location."}
...
k <- kable(df, align = rep("c", ncol(df)),
           caption.short = "Model 0 of Howell's dataset.",
...
k <- kable(df, align = rep("c", ncol(df)),
           caption.short = "Models 1.2 of Howell's dataset.",
...
```{r howell-models, fig.scap="Models on Howeell's datset.", fig.cap="The three main models, model 0, 1.2 and 2.2 on the Howell's dataset colored by section colon, ileum and shape according to the disease: square, ulcerative colitis; triangle, normal; circle, Crohn's disease. Model 0 has just trancriptomic and microbiome data, model 1.2 has transcriptomic, microbiome and sample data and model 2.2 has transcriptomic, microbiome and sample data split in different blocks."}
...
k <- kable(df, align = rep("c", ncol(df)),
           caption.short = "Models 2.2 of Howell's dataset.",
...
k <- kable(df, align = rep("c", ncol(df)), 
           caption.short = "AUC of the RGCCA models on Howell's dataset",
