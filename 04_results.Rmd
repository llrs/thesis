...
![The point with the black circle is the AVE of the original data. The dispersion is shown by the ellipses](images/hsct-bootstrap.png)
...
![MCIA first two synthetic variables on the IBD related cohorts.](images/paper1_MCIA.png)
...
![(#fig:morgans-models) First component of the transcriptome and microbiome of the Morgan's dataset.](images/morgans_models.png)
...
![(#fig:howells-models) The three main models on the Howells dataset. Colored by section colon, ileum and shape according to the disease: square, ulcerative colitis; triangle, normal; circle, Crohn's disease.](images/howells_models.png)
...
![(#fig:howells_bootstrap) Bootstrap of the different models.](images/howells_models_bootstrap.png)
