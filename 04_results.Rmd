...
k <- kable(m1.1, align = rep("c", ncol(m1.1)),
...
k <- kable(as.data.frame(m1.2), 
           align = rep("c", ncol(m1.2)),
...
m2.1 <- data.frame(list(
                   ...
                   Time = c(0, 0, 0, 1, 0), 
                   check.names = FALSE)
k <- kable(m2.1, align = rep("c", ncol(m2.1)),
...
```{r hasler-model-2-2}
m2.2 <- data.frame(list("Model 2.2" = c("RNAseq", "micro", "Location", "Demographic", "Time"), 
...
k <- kable(m2.2, align = rep("c", ncol(m2.2)),
