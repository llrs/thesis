...
![(#fig:hasler-mcia) ROC curve of the different models from RGCCA, discontinued line, and the result with MCIA in gray.](images/paper1_MCIA.png){alt="ROC curve of the different datasets with the models from RGCCA and the result with MCIA"}
...
<!--# TODO: Add points of the modesl on the real dataset -->
