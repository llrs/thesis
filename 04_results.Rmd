...
Different methods, centroid, factorial or X were tested.

The effect of the sparsity value was measured by the number of variables selected.

The look for a good model from the data itself was also tested.

Exploratory analysis with the superblock model was done.

### HSCT dataset

We developed and used the inteRmodel procedure on this dataset

Model with better explanation of known biology and relationships was the model 2.2

### Morgan's dataset

We tested if results of inteRmodel were consistent on this dataset.

Again the model 2.2 was the best according to the AVE score.
