...
df <- data.frame(Factor = c("Location", "IBD", "Sex", "IBD:Sex", "Location:IBD", "Location:Sex", "Location:IBD:Sex", "Residuals"),
                 ...
                 check.names = FALSE)
kable(df, caption.short = "Permanova analysis of transcriptome.",
...
df <- data.frame(Factor = c("Location", "IBD", "Sex", "IBD:Sex", "Location:IBD", "Location:Sex", "Location:IBD:Sex", "Residuals"),
                 ...
                 check.names = FALSE)
kable(df, caption.short = "Permanova analysis of microbiome",
...
With globaltest the results were similar: sex, ibd, location, age and time since diagnosis were able to explain the SESCD score (p-value $5.7 ·10^{-21}  $).
...
<!--# TODO Dobule check this model with the original data -->
...
df <- data.frame(Model = c("0", "1.1", "1.2", "2.1", "2.2"),
         ...
         check.names = FALSE)
kable(df, caption.short = "AVE values of RGCCA models on Häsler's dataset",
...
In contrast to the HSCT's dataset, the model with the highest inner AVE was model 1.2 but model 2.2 was close to it.
...
kable(df, caption.short = "AUC for models with RGCCA on Häsler's dataset",
...
kable(df, caption.short="AUC for Morgan's dataset", 
...
If we look at the classification of the 
...
kable(df, caption.short = "AUC of the RGCCA models on Howell's dataset",
