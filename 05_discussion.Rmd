...
As it is a tool designed to find common patterns based on correlations it requires homogeneous samples.
Having samples from multiple sites and conditions did not help.
...
To study complex systems, new technologies like "organ-on-chip" or more specifically "gut-on-chip" are being developed [@collij2021]. By introducing gut microbiota, these system will be of great help in the stud of the interaction of the gut microbiota dn the intestinal epithelium.
