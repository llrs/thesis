...
This can be seen in the \acr{PCA} which separate colon an ileum on the first dimension: See the \acr{PCA} of the different datasets \@ref(fig:hsct-pca-RNAseq), \@ref(fig:hasler-pca-RNAseq) and \@ref(fig:howell-pca-RNAseq).
...
The variability of microbiome difficults finding clear patterns (See the \acr{PCA} of the different datasets: \@ref(fig:hsct-pca-16s), \@ref(fig:hasler-pca-16s), \@ref(fig:morgan-pca-16s) and \@ref(fig:howell-pca-16s)).
