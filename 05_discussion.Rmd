...
Despite PERMANOVA, `adonis` and `globaltest` worked well to identify which variables about the samples were important, they do not provide variable selection and do not give any insight into which specific microbial species are driving the association between the microbiome and the variables [@susin2020].
\
...
However, As seen on the previous section, this does not prevent all problems with batch effects and let through the worst kind of
