...
In the BARCELONA cohort despite no batch effect as checked with `experDesign` on the second sequencing, the diversity indices suggested that there was some problem with the microbiome data.
