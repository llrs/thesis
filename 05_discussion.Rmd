...
BaseSet didn't work out, too many combinations and problem with numeric precision of multiplying \> 1000 float numbers.
...
Selecting which genes are related to the microorganisms is will require also further validation (for which I didn't have the creativity to think of).
