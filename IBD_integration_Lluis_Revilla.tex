...
Both tables (\ref{tab:hsct-permanova-RNAseq} \ref(tab:hsct-permanova-microbiome)) show that location and IBD is a variable that affects the \protect\hyperlink{acronyms_GE}{GE} and microbiome, but there are some interactions that explain similar percentage of variance.
