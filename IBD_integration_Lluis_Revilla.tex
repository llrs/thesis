...
\titleformat{\chapter}[block]{\fontsize{32pt}{48pt}\bfseries\sffamily\filcenter}{
  \fontsize{72pt}{72pt}\selectfont\scalebox{1.4}[1]{\thechapter \ChapFrame} % Content on the chapter title page
}{0.67em}{\lsstyle}[\thispagestyle{empty} \cleardoublepage]% https://tex.stackexchange.com/a/347162/178206
