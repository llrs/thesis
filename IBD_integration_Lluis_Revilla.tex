...
\caption[Model 1 for the Puget's dataset.]{\label{tab:puget-model1}Model 1 for Puget's dataset. Relationships between the different blocks on the Puget dataset for model 1. 0 indicates no relationship and 1 indicates a strong relationship.}
\centering
...
\caption[Model 1.2 for the Puget's dataset.]{\label{tab:puget-model1-2}Model 1.2 for Puget's dataset. Relationships between the different blocks on the Puget dataset for model 1. 0 indicates no relationship and 1 indicates a strong relationship.}
\centering
\begin{tabular}[t]{|>{}c|c|c|>{}c|}
\hline
...
\caption[Model 2 for the Puget's dataset.]{\label{tab:puget-model2}Model 2 for Puget's dataset. Relationships between the different blocks on the Puget dataset for model 1. 0 indicates no relationship and 1 indicates a strong relationship.}
\centering
...
\caption[Model 2.2 the for Puget's dataset.]{\label{tab:puget-model2-2}Model 2.2 for Puget's dataset. Relationships between the different blocks on the Puget dataset for model 1. 0 indicates no relationship and 1 indicates a strong relationship.}
\centering
\begin{tabular}[t]{|>{}c|c|c|c|>{}c|}
\hline
...
\caption[Model with superblock.2 for the Puget's dataset.]{\label{tab:puget-model-superblock-2}Relationships between the different blocks on the Puget's dataset for model superblock.2. 0 indicates no relationship and 1 indicates a strong relationship.}
\centering
\begin{tabular}[t]{|>{}c|c|c|c|>{}c|}
\hline
\em{\textbf{Model.superblock}} & \em{\textbf{GE}} & \em{\textbf{CGH}} & \em{\textbf{Superblock}} & \em{\textbf{Localization}}\\
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/pugets_models} \caption[Different RGCCA models on the Puget's dataset.]{Different RGCCA models on the Puget's dataset. The different models with the same data showing the sample position on the first components of the CGH  and the transcriptome block. Model 1 and 1.2 with transcriptomics, CGH data and all the data about the samples together. Model 2 and 2.2 with transcriptomics, CGH data and all the data bout the samples on different blocks. Model superblock and superblock.2 have all the data in different blokcs and one block with all the data.}\label{fig:puget-models}
\end{figure}
...
\caption[AVE values of RGCCA models on the Puget's dataset.]{\label{tab:puget-models-ave}AVE values of RGCCA models on the Puget's dataset. Values for both inner and outer AVE of the first canonical component of models 1, 1.2, 2 2.2 and superblock and superblock.2 are shown.}
\centering
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/hsct-ASV-diversity} \caption[Microbiome diversity on the HSCT dataset.]{Microbiome diversity on the HSCT dataset. On the upper section the Shannon effective and on the lower row the Simpson effective diversity splitted by colon and ileum and controls and CD.}\label{fig:hsct-diversity}
\end{figure}
...
\caption[Model 1.2 of the HSCT dataset.]{\label{tab:hsct-model1-2}Relationships between the different blocks on the HSCT dataset for model 1.2. 0 indicates no relationship and 1 indicates a strong relationship.}
\centering
\begin{tabular}[t]{|>{}c|c|c|>{}c|}
\hline
...
\caption[Model 2.2 of the HSCT dataset.]{\label{tab:hsct-model2-2}Relationships between the different blocks on the HSCT dataset for model 2.2. 0 indicates no relationship and 1 indicates a strong relationship.}
\centering
\begin{tabular}[t]{|>{}c|c|c|c|c|>{}c|}
\hline
...
\caption[AVE values of RGCCA models on Häsler's dataset.]{\label{tab:hasler-aves}AVE values of RGCCA models on Häsler's dataset. The inner and the outer AVE scores of multiple models tested on the Häsler dataset are shown. The model with the hightest inner AVE is model 1.2.}
\centering
\begin{tabular}[t]{|>{}c|c|>{}c|}
\hline
\em{\textbf{Model}} & \em{\textbf{inner AVE}} & \em{\textbf{outer AVE}}\\
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/hasler-auc} \caption[AUC of RGCCA models on the Häsler's dataset]{AUC of models with RGCCA on the Häsler's dataset. The classification of the localization of the sample according to the first component of the gene expression of the models generated with RGCCA on the Häsler's dataset.}\label{fig:hasler-auc-plot}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/hasler-mcia} \caption[MCIA dimensions on the Häsler's dataset.]{MCIA dimensions on the Häsler's dataset. MCIA first two dimensions of the dataset colored by state, the shape is according to the location of the samples. Shows two vertical groups on the first syntethic dimension according to the location of the samples.}\label{fig:hasler-mcia}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/morgan-auc} \caption[AUC of RGCCA models on the Morgan's dataset]{AUC of RGCCA models on the Morgan's dataset. The classification of the localization of the sample according to the first component of the gene expression of the models generated with RGCCA on the Morgan's dataset.}\label{fig:morgan-auc-plot}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/morgan-mcia} \caption[MCIA dimensions on the Morgan's dataset.]{MCIA dimensions on the Morgan's dataset. MCIA first two dimensions of the dataset. The color and shape match the location of the sample. There is some separation between samples by location.}\label{fig:morgan-mcia-plot}
\end{figure}
...
\caption[Model 1.2 of the Howell's dataset.]{\label{tab:howell-model1-2}Relationships between the different blocks on the Howell's dataset for model 1.2. 0 indicates no relationship and 1 indicates a strong relationship.}
\centering
\begin{tabular}[t]{|>{}c|c|c|>{}c|}
\hline
...
\caption[Model 2.2 of the Howell's dataset.]{\label{tab:howell-model2-2}Relationships between the different blocks on the Howell's dataset for model 2.2. 0 indicates no relationship and 1 indicates a strong relationship.}
\centering
\begin{tabular}[t]{|>{}c|c|c|c|>{}c|}
\hline
...
\caption[AVE values of RGCCA for the Howell's dataset.]{\label{tab:howell-models-ave}AVE values of RGCCA for the Howell's dataset. The inner and the outer AVE scores of multiple models tested on the Howell dataset are shown. The model with the hightest inner AVE is model 1.2.}
\centering
\begin{tabular}[t]{|>{}c|c|>{}c|}
\hline
\em{\textbf{Model}} & \em{\textbf{inner AVE}} & \em{\textbf{outer AVE}}\\
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/howell-mcia} \caption[MCIA dimensions on the Howell's dataset.]{MCIA dimensions on the Howell's dataset. The first dimensions separates by location.}\label{fig:howell-mcia}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/pathways_hsct_howell} \caption[Pathways from common genes on HSCT and Howell's dataset.]{Significance of pathways on common genes on HSCT and Howell's dataset ordered by p-value, size according to the number of genes on the pathway found on the dataset and color blue for pathways and red for gene ontologies of biological process.}\label{fig:pathways-hsct-howell}
\end{figure}
