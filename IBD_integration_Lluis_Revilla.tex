...
\begin{figure}
\includegraphics[width=1\linewidth]{images/howell-rgcca-auc} \caption[AUC of the RGCCA models on the Howell's dataset.]{AUC of the RGCCA models on the Howell's dataset. The classification of the location of the sample according to the first componenent of the models shown.}\label{fig:howell-auc-plot}
\end{figure}
