...
R version 3.6.3 and the corresponding Bioconductor version 3.9. 
...
A false discovery rate (FDR) correction for multiple testing was performed when necessary. Nominal or FDR p. values <0.05 were considered significant.
