...
\textbf{Introduction}: Inflammatory bowel disease is a complex intestinal disease with several environmental factors that affect each other.
The origin and process that maintains the disease is not fully understood.
There is some evidence that microbiome is related to starting or maintaining this disease.
Finding relationships between microbiome and gastrointestinal mucosa could help advance treatments, diagnosis or prevent it.

\textbf{Methods}: We based our analysis on intestinal bacterial 16S and human transcriptome data from biopsies from multiple timepoints and intestine segments.
...
The results were compared with multiple co-inertia analysis and classified samples according to their location.
...
\textbf{Results}: Splitting samples variables into different blocks results on models of these relationships that show differences on the genes and microorganisms selected.
...
Our method finds how strong are the relationships of microbiome, transcriptome and environmental variables.
...
There are many factors that influence the gut microbiome {[}\protect\hyperlink{ref-hasan2019}{232}{]}. But the role of microbiome in IBD has gained a lot of attention in the last 10 years {[}\protect\hyperlink{ref-khanna2014}{16}, \protect\hyperlink{ref-bringiotti2014}{233}, \protect\hyperlink{ref-lloyd-price2019}{234}{]}.
