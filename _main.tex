...
On model 2 we split the invariable variables from those related to the location (able \ref{tab:puget-model2}:
...
\caption[Model 0 of H<U+00E4>sler dataset]{\label{tab:hasler-model-0}Model 0 of H<U+00E4>sler dataset}
\centering
\begin{tabular}[t]{l|r|r}
\hline
  & RNAseq & micro\\
...
\caption[Model 1.1 of H<U+00E4>sler dataset]{\label{tab:hasler-model-1-1}Model 1.1 of H<U+00E4>sler dataset}
\centering
...
\caption[Model 1.2 of H<U+00E4>sler dataset]{\label{tab:hasler-model-1-2}Model 1.2 of H<U+00E4>sler dataset}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
  & RNAseq & micro & meta\\
...
\caption[Model 2.1 of H<U+00E4>sler dataset]{\label{tab:hasler-model-2-1}Model 2.1 of H<U+00E4>sler dataset}
\centering
...
\caption[Model 2.2 of H<U+00E4>sler dataset]{\label{tab:hasler-model-2-2}Model 2.2 of H<U+00E4>sler dataset}
\centering
\begin{tabular}[t]{l|r|r|r|r|r}
\hline
  & RNAseq & micro & Location & Demographic & Time\\
...
\caption[AVE values of RGCCA models on H<U+00E4>sler's dataset]{\label{tab:hasler-aves}AVE values of RGCCA models on H<U+00E4>sler's dataset. The inner and the outer AVE scores of multiple models tested on the H<U+00E4>sler dataset are shown. The model with the hightes inner AVE is model 1.2.}
\centering
\begin{tabular}[t]{l|r|r}
\hline
Model & inner AVE & outer AVE\\
...
\caption[AUC for models with RGCCA on H<U+00E4>sler's dataset]{\label{tab:hasler-auc}AUC for models with RGCCA on H<U+00E4>sler's dataset. The AUC was calculated with the first dimension of the gene expression block ability to predict location of the sample.}
\centering
\begin{tabular}[t]{l|r}
\hline
Model & AUC\\
