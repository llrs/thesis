...
\begin{figure}
\includegraphics[width=1\linewidth]{images/hsct-features} \caption[Upset plot of variables selected on HSCT dataset.]{Upset plot of the variables selected on each model from 0 to 2.3 showing the intersection between them regarding genes and OTUs.}\label{fig:hsct-features}
\end{figure}
...
A comparison of the taxonomy of the annotated microbiome on the datasets is the next possiblity.
...
Some studies using host transcriptomics of faecal wash infer inflammation without colonoscopy {[}\protect\hyperlink{ref-ungar2022}{240}{]}.
