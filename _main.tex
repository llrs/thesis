...
\hline
\em{\textbf{Model 2}} & \em{\textbf{Transcriptome}} & \em{\textbf{Microbiome}} & \em{\textbf{Location}} & \em{\textbf{Demographic}} & \em{\textbf{Time}}\\
\hline
...
Following this split, we used inteRmodel (See section above \ref{intermodel}) to find the model that has higher inner AVE for these blocks is the one on table \ref{tab:hsct-model2-2}:
