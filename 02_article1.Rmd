...
Output:
Specific factors
Interpretation: Depending on the model and options used


Over several years of progress [@tenenhaus_component-based_2008; 
@esposito_vinzi_bridge_2010; @tenenhaus_regularized_2011; 
@tenenhaus_regularized_2014; @tenenhaus_variable_2014; @tenenhaus_kernel_2015] 
on the field of canonical correlations it provides a robust method and 
there is an implementation [@R-RGCCA].
