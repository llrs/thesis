...
Not possible to find causal relationships.
...
Average variance explained (AVE), inner and outer
...
[MCIA](https://bioconductor.org/packages/omicade4 "Omicade4") was used to compare with the new method [@mengMultivariateApproachIntegration2014].

[Maaslin2](https://bioconductor.org/packages/Maaslin2 "Maaslin2")

## Conclusions

This has been [pre-published](https://www.medrxiv.org/content/10.1101/2020.04.16.20031492v1 "Preprint") and is now published on Plus One.
